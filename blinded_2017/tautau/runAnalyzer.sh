...
./$f_exe /hdfs/store/user/jmadhusu/blinded_data/2017/tautau/Tau_EraB_00.root Tau_Era_test.root $nEvents 1000 2017 DATA Tau_Era

./$f_exe /hdfs/store/user/jmadhusu/2017_skimmed/signal_gg/MH3_900_MH4_300.root signal_test.root $nEvents 1000 2017 MC signal
end=`date +%s`
runtime=$((end-start))
