...
//#include "TauTriggerSFs/SFProvider.cc"
...
public :
  ...
  /* TH1F  *h_tauTrgSF_dm0  = (TH1F*) f_tauTrgSf->Get("sf_ditau_Medium_dm0_fitted"); */
  /* TH1F  *h_tauTrgSF_dm1  = (TH1F*) f_tauTrgSf->Get("sf_ditau_Medium_dm1_fitted"); */
  /* TH1F  *h_tauTrgSF_dm10 = (TH1F*) f_tauTrgSf->Get("sf_ditau_Medium_dm10_fitted"); */
  /* TH1F  *h_tauTrgSF_dm11 = (TH1F*) f_tauTrgSf->Get("sf_ditau_Medium_dm11_fitted"); */
  
  /* TH1F  *h_tauTrgSF_AI_dm0  = (TH1F*) f_tauTrgSf->Get("sf_ditau_VVVLoose_dm0_fitted"); */
  /* TH1F  *h_tauTrgSF_AI_dm1  = (TH1F*) f_tauTrgSf->Get("sf_ditau_VVVLoose_dm1_fitted"); */
  /* TH1F  *h_tauTrgSF_AI_dm10 = (TH1F*) f_tauTrgSf->Get("sf_ditau_VVVLoose_dm10_fitted"); */
  /* TH1F  *h_tauTrgSF_AI_dm11 = (TH1F*) f_tauTrgSf->Get("sf_ditau_VVVLoose_dm11_fitted"); */
  ...
  /* //using namespace tau_trigger; */
  /* SFProvider* tauTrgsf_m=new SFProvider("sf_files/TauTriggerSFs/data/2017_tauTriggerEff_DeepTau2017v2p1.root","ditau", "Medium"); */
  /* SFProvider* tauTrgsf_vl=new SFProvider("sf_files/TauTriggerSFs/data/2017_tauTriggerEff_DeepTau2017v2p1.root","ditau", "VVVLoose"); */
  std::vector<std::pair<string, int>> tauDM_map;
  TLorentzVector my_tau1P4;
  TLorentzVector my_tau2P4;
  TLorentzVector my_metP4;
  
  TLorentzVector my_tau1P4_nom_5, my_tau2P4_nom_5, my_metP4_nom_5;
  TLorentzVector my_tau1P4_nom_9, my_tau2P4_nom_9, my_metP4_nom_9;
  TLorentzVector my_tau1P4_nom_5dyll, my_tau2P4_nom_5dyll, my_metP4_nom_5dyll;
  TLorentzVector my_tau1P4_nom_9dyll, my_tau2P4_nom_9dyll, my_metP4_nom_9dyll;
  std::vector<int> tau1Cand, tau2Cand;
  std::vector<int> tau1Cand_nom, tau2Cand_nom;
  ...
  // Declaration of leaf types
   ...
   vector<int> getTauCand_noID(double pt, double eta, int shift);
   vector<int> getJetCand(int eleIndex, int tauIndex);
   void     selections(float weight, int shift, string uncObject);

   int getTau1Cand(double pt, double eta, int shift);
   int getTau1Cand_noID(double pt, double eta, int shift);
   int getTau2Cand(double pt, double eta, int tau1Index, int shift);
   int getTau2Cand_noID(double pt, double eta, int tau1Index, int shift);
   ...
   TLorentzVector applyTau1ESCorrections( TLorentzVector tauP4, int tauIndex, int shift);
   ...
   bool compareTauIsoFunc(int &a, int &b);
...
void tautau_analyzer::save_nom(){

  if (stage=="5")
    {
      l1_genmatching_nom = my_genmatching_l1;
      l2_genmataching_nom = my_genmatching_l2;
      my_tau2P4_nom_5 = my_tau2P4;
      my_tau1P4_nom_5 = my_tau1P4;
  ...
  if (stage=="9")
    {
      l1_genmatching_nom = my_genmatching_l1;
      l2_genmataching_nom = my_genmatching_l2;
      my_tau2P4_nom_9 = my_tau2P4;
      my_tau1P4_nom_9 = my_tau1P4;
