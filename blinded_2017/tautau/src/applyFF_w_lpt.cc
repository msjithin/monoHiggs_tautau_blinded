...
public:
  ...
  applyFF_w_lpt(){
    ...
    frawff = TFile::Open("sf_files/FF_lptCorrInBinsOfTauPt/FF_differential/ff_files_tt_2017/uncorrected_fakefactors_tt.root");
    ...
    frawff_tt = TFile::Open("sf_files/FF_lptCorrInBinsOfTauPt/FF_differential/ff_files_tt_2017/raw_FF_tautau_unfitted.root");
    ...
    fmvisclosure = TFile::Open("sf_files/FF_lptCorrInBinsOfTauPt/FF_differential/ff_files_tt_2017/FF_corrections_1.root");
