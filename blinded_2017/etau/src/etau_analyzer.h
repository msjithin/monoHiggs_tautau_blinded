...
public :
  ...
  TF1 *fn_tauIDSF_vvvl = (TF1*) f_tauidSF->Get("VVLoose_cent");
  ...
  bool is_MC;
  KIT_lepton_SF TrgEle35, TrgEle32orEle35, CrossTriggerSF, ElectronIDIso;
...
void etau_analyzer::Init(TChain *tree, string _isMC_ , string sampleName)
{
  ...
  //cout<<__LINE__<<endl;
  TrgEle32orEle35.init_ScaleFactors("sf_files/LeptonEfficiencies/Electron/Run2017/Electron_Ele32orEle35.root");
  //cout<<__LINE__<<endl;
  TrgEle35.init_ScaleFactors("sf_files/LeptonEfficiencies/Electron/Run2017/Electron_Ele35.root");
  //cout<<__LINE__<<endl;
