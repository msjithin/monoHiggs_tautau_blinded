...
# ./$f_exe /hdfs/store/user/jmadhusu/blinded_data/2018/tautau/TauA_00.root TauA_test.root $nEvents 1000 2018 DATA Tau_EraA

# ./$f_exe /hdfs/store/user/jmadhusu/2018_skimmed/signal_gg/MH3_900_MH4_500.root sample_test.root $nEvents 1000 2018 MC MH3_900_MH4_500 $outDir
end=`date +%s`
runtime=$((end-start))
