...
public :
  ...
  TauIDSFTool tauSFTool{"2018ReReco","DeepTau2017v2p1VSjet","Medium"};
  MEtSys metSys;
  KITMuSF TrgEle35;
  ...
  TLorentzVector my_tauP4, my_eleP4, my_metP4;
  TLorentzVector my_tauP4_nom_5, my_eleP4_nom_5, my_metP4_nom_5;
  TLorentzVector my_tauP4_nom_9, my_eleP4_nom_9, my_metP4_nom_9;
  TLorentzVector my_tauP4_nom_5dyll, my_eleP4_nom_5dyll, my_metP4_nom_5dyll;
  TLorentzVector my_tauP4_nom_9dyll, my_eleP4_nom_9dyll, my_metP4_nom_9dyll;
  std::vector<int> eleCand, tauCand, aisrtauCand;
  std::vector<int> eleCand_nom, tauCand_nom, aisrtauCand_nom;
  ...
  int EleIndex_nom, TauIndex_nom, EleIndex_nomdyll, TauIndex_nomdyll;
  ...
  // Declaration of leaf types
   ...
   etau_analyzer(const char* file1, const char* file2, string isMC, string SampleName, string year);
   ~etau_analyzer();
   ...
   void     selections(float event_weight, int shift, string uncObject);
   Bool_t   Notify();
   void     Show(Long64_t entry = -1);
   void BookHistos(const char* file1, const char* file2, string year);
   void fillHistos(int histoNumber, double event_weight,int higgs_index);
   double DeltaPhi(double phi1, double phi2);
   vector<int> getEleCand(double pt, double eta, int shift);
   ...
   TLorentzVector metClusteredUnc( TLorentzVector nominal_met);
...
etau_analyzer::etau_analyzer(const char* file1, const char* file2, string isMC, string sampleName, string year)
{
...
void etau_analyzer::setMyEleTau(int eleIndex, int tauIndex, TLorentzVector event_metP4, int shift){
...
void etau_analyzer::save_nom(){

  if (stage=="5_dyll")
    {
      EleIndex_nomdyll = EleIndex;
  ...
  if (stage=="9")
    {
      ...
      my_eleP4_nom_9 = my_eleP4;
      my_metP4_nom_9 = my_metP4;
      my_njets_nom_9 = my_njets;
    }
}

void etau_analyzer::make_met_plot(string sys_name, string hnumber, float event_weight){
  if( unc_shift == "nominal") 
    plotFill("pfmet_nominal"+hnumber, my_metP4.Pt() , 20, 0, 200,  event_weight);

  if (unc_shift == "up" && selected_systematic=="metresponse")
    {
      //cout<<" filling "<<"pfmet_response_up"<<hnumber<<endl;
      plotFill("pfmet_response_up"+hnumber, my_metP4.Pt() , 20, 0, 200,  event_weight);
    }
  else if (unc_shift == "down" && selected_systematic=="metresponse")
    plotFill("pfmet_response_down"+hnumber, my_metP4.Pt() , 20, 0, 200,  event_weight);
  else if (unc_shift == "up" && selected_systematic=="metresolution")
    plotFill("pfmet_resolution_up"+hnumber, my_metP4.Pt() , 20, 0, 200,  event_weight);
