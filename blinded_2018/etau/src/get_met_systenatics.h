TLorentzVector etau_analyzer::metSysUnc(string uncType, TLorentzVector event_metP4){
  ...
  /* cout <<"          "<<" up  "<<"       down "<<endl; */
  /* cout <<"response"<<" ex "<<" "<<pfmetcorr_ex_responseUp<<" "<<pfmetcorr_ex_responseDown<<endl; */
  /* cout <<"response"<<" ey "<<" "<<pfmetcorr_ey_responseUp<<" "<<pfmetcorr_ey_responseDown<<endl; */
  /* cout <<"resolution"<<" ex "<<" "<<pfmetcorr_ex_resolutionUp<<" "<<pfmetcorr_ex_resolutionDown<<endl; */
  /* cout <<"resolution"<<" ey "<<" "<<pfmetcorr_ey_resolutionUp<<" "<<pfmetcorr_ey_resolutionDown<<endl; */
  /* cout<<" ********************************************"<<endl; */
  /* cout<<" met nominal "<<mymetvector.Pt()<<endl; */
  /* TLorentzVector responseUp, resolutionUp, responseDown, resolutionDown; */
  /* responseUp.SetPxPyPzE(pfmetcorr_ex_responseUp,pfmetcorr_ey_responseUp,0,sqrt(pfmetcorr_ex_responseUp*pfmetcorr_ex_responseUp+pfmetcorr_ey_responseUp*pfmetcorr_ey_responseUp)); */
  /* resolutionUp.SetPxPyPzE(pfmetcorr_ex_resolutionUp,pfmetcorr_ey_resolutionUp,0,sqrt(pfmetcorr_ex_resolutionUp*pfmetcorr_ex_resolutionUp+pfmetcorr_ey_resolutionUp*pfmetcorr_ey_resolutionUp)); */
  /* responseDown.SetPxPyPzE(pfmetcorr_ex_responseDown,pfmetcorr_ey_responseDown,0,sqrt(pfmetcorr_ex_responseDown*pfmetcorr_ex_responseDown+pfmetcorr_ey_responseDown*pfmetcorr_ey_responseDown)); */
  /* resolutionDown.SetPxPyPzE(pfmetcorr_ex_resolutionDown,pfmetcorr_ey_resolutionDown,0,sqrt(pfmetcorr_ex_resolutionDown*pfmetcorr_ex_resolutionDown+pfmetcorr_ey_resolutionDown*pfmetcorr_ey_resolutionDown)); */
  /* cout<<" met response   up: "<< responseUp.Pt() << "   down "<<responseDown.Pt()<<endl; */
  /* cout<<" met resolution  up: "<< resolutionUp.Pt() << "   down "<<resolutionDown.Pt()<<endl; */
  /* cout<<"  "<<endl; */
  string njetName ="";
