...
./analyze_mutau /hdfs/store/user/jmadhusu/2018_skimmed/mutau/SingleMuonA_00.root SingleMuonA_00_test.root $nEvents 1000 2018 DATA SingleMuonA_00

./analyze_mutau /hdfs/store/user/jmadhusu/2018_skimmed/signal_gg/MH3_800_MH4_500.root signal_test.root $nEvents 1000 2018 MC MH3_800_MH4_500
end=`date +%s`
runtime=$((end-start))
