...
#ifndef skimm_signal_2017_h
#define skimm_signal_2017_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   //   skimm_signal_2017(TTree *tree=0);
   skimm_signal_2017(const char* file1, const char* file2, string isMC);
   virtual ~skimm_signal_2017();
...
#ifdef skimm_signal_2017_cxx
skimm_signal_2017::skimm_signal_2017(const char* file1, const char* file2, string isMC)
{
...
skimm_signal_2017::~skimm_signal_2017()
{
   if (!fChain) return;
...
Int_t skimm_signal_2017::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t skimm_signal_2017::LoadTree(Long64_t entry)
{
...
void skimm_signal_2017::Init(TChain *tree, string _isMC_)
{
...
Bool_t skimm_signal_2017::Notify()
{
...
void skimm_signal_2017::Show(Long64_t entry)
{
...
Int_t skimm_signal_2017::Cut(Long64_t entry)
{
...
#endif // #ifdef skimm_signal_2017_cxx
