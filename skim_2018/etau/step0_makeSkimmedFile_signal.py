...
os.popen('ls -d /hdfs/store/user/jmadhusu/Signal_Zpbaryonic2018_*/*/*/*/* > '+tmpfile)
...
writeString = """
./MakeCondorFiles.csh analyze_signal {inputdir}/ {outputfile}.root -1 1000 2018 MC {outputfile} $outDir 
"""

for line in inputFile:
    line = line.strip()
    sample = 'Signal_Zpbaryonic2018_' + line.split('/')[-1][-2:]
    print sample
